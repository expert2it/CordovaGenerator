...
{
    public partial class cgBrowserUserControl : UserControl
    {
        public IWinFormsWebBrowser Browser { get; private set; }
        private IntPtr browserHandle;
        private ChromeWidgetMessageInterceptor messageInterceptor;
        private bool multiThreadedMessageLoopEnabled;
        public cgBrowserUserControl(Action<string, int?> openNewTab, string url, bool multiThreadedMessageLoopEnabled)
        {
            InitializeComponent();
            ...
            // **** Custom JS binding ****
            browser.RegisterJsObject("boundCustomObject", new boundCustomObject(browser, this));
            //browser.RegisterAsyncJsObject("boundAsyncCustomObject", new AsyncBoundObject());
        ...
        private void OpenDevButtonClick(object sender, EventArgs e)
        {
            Browser.ShowDevTools();
        }
 
        private void DevCloseButtonClick(object sender, EventArgs e)
        {
